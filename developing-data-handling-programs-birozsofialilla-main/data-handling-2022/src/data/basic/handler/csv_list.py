...
def read_cars(path: str, file_name: str = "motorbikes.csv", delimiter: str = ";") -> list[Car]:
...
def write_cars(cars: list[Car], path: str, file_name: str = "motorbikes.csv", delimiter: str = ";") -> None:
...
def read_airports(path: str, file_name: str = "streets.csv", delimiter: str = ";") -> list[Airport]:
...
def write_airports(airports: list[Airport], path: str, file_name: str = "streets.csv", delimiter: str = ";") -> None:
